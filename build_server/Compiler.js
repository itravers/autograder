...
class Compiler {
   constructor(files, workspace_path, assignment_id, student_id, tools_setup_cmd, compile_cmd, stdin) {
      this.files = files;
   ...
   /**
    * Step #1: Save files sent to us via JSON onto local file system
    */
   saveFiles(files) {
